...
<br>
Tech Stack <br>
List the key technologies used to build the deshboard<br>
Example:<br>
1. The deshboard was built using the following tools and technologies<br>
2. Power BI Deshboard - Main data visulation platform used for report creation .<br>
3. Power Quary - Data transformation and cleaning layer for reshaping and preparing the data .<br>
4. Data Modeling - Relationships established among tables to enable cross-filtering and aggregation .<br>
5. File Format - .pbix fro development and .png for deshboard previews.
